 ...
 * Login view
 */
public class Login_Activity extends AppCompatActivity implements IAccountValidation.View {
    ...
    protected void onResume() {
        super.onResume();
        AccountPreferences accountPreferences = new AccountPreferences(Login_Activity.this);
        edtUser.setText(accountPreferences.getUser());
        edtPass.setText(accountPreferences.getPassword());
    }
    ...
    public void startActivity() {
        Intent i = new Intent(Login_Activity.this, ManageProduct_Activity.class);
        startActivity(i);
    }
}
