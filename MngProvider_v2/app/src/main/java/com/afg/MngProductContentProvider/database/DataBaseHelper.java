...
public final class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        try {
            ...
            sqLiteDatabase.execSQL(DataBaseContract.CategoryEntry.INSERT_ENTRIES);
            sqLiteDatabase.execSQL(DataBaseContract.ProductEntry.INSERT_ENTRIES);
            sqLiteDatabase.execSQL(DataBaseContract.PharmacyEntry.INSERT_ENTRIES);
            sqLiteDatabase.execSQL(DataBaseContract.InvoiceEntry.SQL_INSERT_ENTRIES);
