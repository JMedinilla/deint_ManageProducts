...
public class ImageResource {
    ...
    /**
     * Metodo para evitar el error OUTOFMEMORY
     */
    ...
    public static Bitmap decodeUri(Uri selectedImage) throws FileNotFoundException {
        ...
        BitmapFactory.decodeStream(ManageProductApplications.getContext().getContentResolver().openInputStream(selectedImage), null, o);
        ...
        return BitmapFactory.decodeStream(ManageProductApplications.getContext().getContentResolver().openInputStream(selectedImage), null, o2);
