 ...
 *
 * My personal adapter for the products ListView (A -> Worst way to do it)
 */
public class
ProductAdapter_A extends ArrayAdapter<Product> {
    public ProductAdapter_A(Context context) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.adapter_image_first, parent, false);
