 ...
 * Sign up presenter
 */
public class RegisterPresenterImpl implements RegisterPresenter.PresenterUser, RegisterPresenter.Presenter {
     ...
     */
    public RegisterPresenterImpl(LoginPresenter.View view) {
        this.view = view;
    ...
    private void savePreferences(String user, String pass, String mail) {
        AccountPreferencesImpl preferences = new AccountPreferencesImpl(this.context);
